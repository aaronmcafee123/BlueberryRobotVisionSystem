...
def parse_args():
    p = argparse.ArgumentParser(description="Train a YOLOv5 detector on a split dataset")
    p.add_argument("--dataset_dir", required=True, help="Root with images/{train,val,test} and labels/{train,val,test}")
    p.add_argument("--weights", default="yolov5s.pt", help="YOLOv5 weights to start from (e.g., yolov5n/s/m/l/x.pt)")
    ...
    p.add_argument("--device", default="auto", help="Device, e.g. 0 or cpu or auto or 0,1")
    ...
    p.add_argument("--name", default="exp_yolov5", help="Experiment name")
    p.add_argument("--seed", type=int, default=42, help="Random seed")
    p.add_argument("--lr0", type=float, default=None, help="Initial learning rate (leave unset for default)")
    p.add_argument("--lrf", type=float, default=None, help="Final LR fraction (cosine end factor)")
